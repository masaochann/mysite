$(function(){
	...
	winRsize();
	$(window).resize(function(){winRsize();});
	function winRsize()
	{
	...
	for(var i=0; i<=items; i++)
	{
		...
		field.append('<div class="bubble move'+move+' pos'+pos+'"><div class="scale'+scale+'"><div class="shake'+shake+'"><span class="item'+color+'"></span></div></div>'); //  stretch'+stretch+'
	}
});
